...
SHOULD：模拟测验、进度面板、计划历史、PDF 预览、简答题。COULD：FSRS、总结、Anki、Obsidian、NotebookLM、DeepTutor、向量搜索。WON'T v0.1：认证/多用户、教师或家长后台、社交、音视频教师、默认多 Agent、复杂知识追踪、大型向量库、通知与 cron、用户删除 Source（避免已有引用悬空）。
